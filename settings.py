...
CONSUMER_KEY = os.environ.get("CONSUMER_KEY", "thisIsaconsumerkey")
SHARED_SECRET = os.environ.get(
    "SHARED_SECRET", "anevenhardertoguesssecret")
...
secret_key = os.environ.get("SECRET_FLASK", "thisistheflasksessionkey")
